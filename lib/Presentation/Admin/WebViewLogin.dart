...
class LoginScreenWeb extends StatelessWidget {
  LoginScreenWeb({Key? key, required this.schdomain}) : super(key: key);
  String schdomain;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Center(
          child: WebView(
            initialUrl: 'https://$schdomain.eschoolweb.org/curriculum/tab-mark-entry',
...
// class LoginScreenWeb extends StatelessWidget {
//   LoginScreenWeb({Key? key, required this.token}) : super(key: key);
//   String token;
...
//   @override
//   _LoginScreenWebState createState() => new _LoginScreenWebState();
// }
...
//                                   url: Uri.parse(
//                                       "https://rainbowuat.essuatonline.in/login"
