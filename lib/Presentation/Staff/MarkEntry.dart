 ...
 void _updateScore(val){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<MarkEntryProvider>(
        builder: (context, value, child) {
            ...
            children: [
                      ...
                      onPressed: (() async {
                        ...
                        markEntryExamListController.text.toString();
                             await Provider.of<MarkEntryProvider>
                               (context,listen: false).clearStudentMEList();
              ...
              Consumer<MarkEntryProvider>(
                builder: (context, providerr, child) {
                  ...
                  providerr.maxmarkList.isEmpty || providerr.maxmarkList == null
                  ) {
                    return Container(
                      width: 0, height: 0,
                    );
              ...
              else if(providerr.typecode =="UAS" && providerr.maxmarkList[0].entryMethod=="Grade"){
          ...
          gradeListController.add(TextEditingController());
          gradeListController1.add(TextEditingController());

          gradeListController1[index].text =
          value.studentMEList[index].teGradeId == null
              ? gradeListController1[index].text
              : value.studentMEList[index].gradeId
              .toString();
            ...
            children: [
              Container(
                ...
                child: TextField(
                  ...
                  textAlign: TextAlign
                      .center,
                  controller:gradeListController[index] ,
                  decoration:
        ...
        obj.add(

          {
            ...
            "rollNo": value.studentMEList[i].rollNo
                .toString(),
            "studentPresentDetailsId": value.studentMEList[i]
                .studentPresentDetailsId.toString(),
          ...
          obj.add(

            {
              ...
              "disableAbsentRow": false
                      ...
                      await value.markEntrySave(courseId, divisionId, partId,markEntryOptionSubListController1
                          .text,subjectId,markEntryExamListController.text.toString(), date!, context, obj);
    ...
    onPressed: () async{
      ...
      i++) {
        obj.add(

          {
            ...
            "studentPresentDetailsId": value.studentMEList[i].studentPresentDetailsId.toString(),
            "teMark": value.studentMEList[i].teMark,
            "peMark": null,
            "ceMark": null,
            "teGrade": value.studentMEList[i].teGrade,
            "peGrade": null,
            "ceGrade": null,
            "totalMark": value.studentMEList[i].totalMark,
            "markInPer": null,
            "grade": null,
            "gradeId": null,
            "teGradeId": value.studentMEList[i].teGradeId,
            "peGradeId": null,
            "ceGradeId": null,
            "attendance": value.studentMEList[i].attendance.toString(),
            "description": null,
            "disableAbsentRow": false
          },
      ...
      if (markEntryDivisionListController.text.isEmpty &&
        ...
        value.loading
            ...
            :
        //await value.markEntrySave(courseId,divisionId,partId,subjectId,date!,markEntryExamListController.text.toString(),context, obj);
        await value.markEntryVerify(courseId, divisionId, partId,markEntryOptionSubListController1
            .text ,subjectId,markEntryExamListController.text.toString(), date!, context, obj);
    ...
    ? spinkitLoader()
        :
    //await value.markEntrySave(courseId,divisionId,partId,subjectId,date!,markEntryExamListController.text.toString(),context, obj);
    await value.markEntryDelete(courseId, divisionId, partId,markEntryOptionSubListController1
        .text ,subjectId,markEntryExamListController.text.toString(), date!, context, obj);
    value.examStatus="Pending";
    }
    },
