...
class CurriculamPage extends StatefulWidget {
  String token;

  CurriculamPage({Key? key, required this.token}) : super(key: key);

  @override
  _CurriculamPageState createState() => new _CurriculamPageState();
}

class _CurriculamPageState extends State<CurriculamPage> {
