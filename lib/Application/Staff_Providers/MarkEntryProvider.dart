...
//Optional subject List
  ...
  Future markEntrySave(String course,String divison,String part,String subSubject,String subject,String exam,String date,
      BuildContext context, List finallList) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    ...
    var request = http.Request('POST',
        Uri.parse('${UIGuide.baseURL}/markentry/save'));
    ...
    if (response.statusCode == 200) {
      ...
      await AwesomeDialog(
          ...
          btnOkOnPress: () async {
            await getMarkEntryView(course, date, divison, exam, part, subject);
          },
  ...
  Future markEntryVerify(String course,String divison,String part,String subSubject,String subject,String exam,String date,
      BuildContext context, List finallList) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    ...
    var request = http.Request('POST',
        Uri.parse('${UIGuide.baseURL}/markentry/verify'));
...
//delete
  ...
  Future markEntryDelete(String course,String divison,String part,String subSubject,String subject,String exam,String date,
      BuildContext context, List finallList) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    ...
    var request = http.Request('POST',
        Uri.parse('${UIGuide.baseURL}/markentry/delete'));
    ...
    if (response.statusCode == 200) {
      ...
      await AwesomeDialog(
          ...
          btnOkColor: Color.fromARGB(255, 185, 61, 61)
      )
          .show();
